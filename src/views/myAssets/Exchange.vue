...
<template>
    <div class="exchange-body">
        ...
        <MyInput isLarge v-model="fromData.amount" :placeholder="$t('exchange.pla1')" :errorObj="errorObj"
            ...
            <template #suffix>
                <div class="currency-suffix">
                    <el-select popper-class="my-select-popper" v-model="fromData.fromCurrency" size="large" class="currency-select"
        ...
        <MyInput isLarge :model-value="formattedTargetAmount" :errorObj="errorObj"
            ...
            <template #suffix>
                <div class="currency-suffix">
                    <el-select popper-class="my-select-popper" v-model="fromData.toCurrency" size="large" class="currency-select"
