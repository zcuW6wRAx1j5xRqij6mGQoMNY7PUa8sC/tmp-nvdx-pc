    ...
    <div class="withdraw-container" v-loading="loading">
        ...
        <div class="from-box">
            ...
            <template v-else>
                ...
                <el-select-v2 popper-class="my-select-popper" v-model="fromData.document_type" size="large" :placeholder="t('assets.text.text21')"
                    class="mb-4" :options="dataList" />
                <el-select popper-class="my-select-popper" v-model="fromData.country_id" size="large" :placeholder="t('my.realName.pla1')" class="mb-4"
                    filterable>
