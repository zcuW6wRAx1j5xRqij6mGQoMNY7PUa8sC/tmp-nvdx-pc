...
<template>
    <div class="trading-operation" v-loading.fullscreen.lock="fullscreenLoading">
        <MyTab :tabList="typeList" :tabActive="typeActive" @tabChange="typeChange" class="flex-shrink-0 mb-4 w-full"
            isBlock />
        <el-select popper-class="my-select-popper"  size="large"  v-model="fromData.margin_type" @change="resetFrom"
        ...
        <el-select popper-class="my-select-popper"  size="large"  v-model="fromData.leverage" @change="resetFrom"
        ...
        <el-select popper-class="my-select-popper"  size="large" v-model="fromData.document_type"  :placeholder="$t('tradingCommon.placeholder.text1')"
            @change="selectChange">
